...
#define PMU_IRQ_N5007		GPIO_PA(0) //PE2
#define PMU_SLEEP           GPIO_PA(1)
#endif /* CONFIG_REGULATOR_SM5007 */

#define BAT_PRE_TEST        GPIO_PC(22)
/* ****************************GPIO PMU END********************************** */
...
/* ****************************GPIO MMC START******************************** */
#define GPIO_MMC_RST_N			GPIO_PA(3)
...
/* ****************************GPIO WIFI START******************************* */
#define BCM_POWER_NAME   LDO7_NAME
#define BCM_PWR_EN       (-1)
