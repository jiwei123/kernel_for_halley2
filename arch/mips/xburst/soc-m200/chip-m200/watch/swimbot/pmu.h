...
#define LDO1_NAME      "wifi_vddio_1v8" //"blvss"      // ELVSS-3.4V
...
#if defined(CONFIG_AW808_HW_V11_NATURAL_ROUND) || defined(CONFIG_AW808_HW_V11_WISE_SQUARE) || defined(CONFIG_SWIMBOT_HW)
