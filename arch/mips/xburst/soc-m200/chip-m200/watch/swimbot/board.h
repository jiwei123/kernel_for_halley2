...
#define GPIO_LCD_CS            GPIO_PC(17)
#define GPIO_LCD_RD            GPIO_PC(14)
#define GPIO_BL_PWR_EN         GPIO_PC(24)
#define GPIO_LCD_RST           GPIO_PC(19)
#define SLCD_TE_GPIO           GPIO_PC(27)
#define VCC_LCD_1V8_NAME       LDO4_NAME
...
//elink_zqb add bengin for headphonel 20151120
#define GPIO_HEADPHONEL_SPEAKER_EN		GPIO_PF(6)      /*speaker enable1 gpio*/
#define GPIO_HEADPHONEL_SPEAKER_EN_LEVEL	1

#define GPIO_HEADPHONER_SPEAKER_EN		GPIO_PF(7)      /*speaker enable1 gpio*/
#define GPIO_HEADPHONER_SPEAKER_EN_LEVEL	1
//elink_zqb add end for headphonel 20151120
...
#define HP_SENSE_ACTIVE_LEVEL	-1//elink_zqb modify for hearp speaker 0
...
/* ****************************GPIO EM30719 START**************************** */
#define GPIO_EM30719_INT    GPIO_PC(14)
#define EM30719_VDD_NAME    LDO3_NAME
/* ****************************GPIO EM30719 END****************************** */
