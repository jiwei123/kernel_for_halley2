...
__initdata int gpio_ss_table[][2] = {
    ...
    { 32 * 0 + 2, GSS_OUTPUT_LOW }, /* SP_SHUTDOWN_N */
    ...
    { 32 * 0 + 9, GSS_INPUT_NOPULL }, /* MCU_WAKEUP */
    ...
    { 32 * 0 + 14, GSS_IGNORE }, /* TP_RST*/
    { 32 * 0 + 15, GSS_IGNORE }, /* SENSOR_INT1 */

    { 32 * 0 + 18, GSS_INPUT_NOPULL }, /* MSC0_CLK */
    ...
    /* GPIO Group - C */
    { 32 * 2 + 2, GSS_INPUT_NOPULL }, /* SLCD_D0_NC */
    { 32 * 2 + 3, GSS_INPUT_NOPULL }, /* SLCD_D1_NC */
    { 32 * 2 + 4, GSS_INPUT_NOPULL }, /* SLCD_D2_NC */
    { 32 * 2 + 5, GSS_INPUT_NOPULL }, /* SLCD_D3_NC */
    { 32 * 2 + 6, GSS_INPUT_NOPULL }, /* SLCD_D4_NC */
    { 32 * 2 + 7, GSS_INPUT_NOPULL }, /* SLCD_D5_NC */
    { 32 * 2 + 8, GSS_INPUT_NOPULL }, /* SLCD_D6_NC */
    { 32 * 2 + 9, GSS_INPUT_NOPULL }, /* SLCD_D7_NC */
    { 32 * 2 + 12, GSS_INPUT_NOPULL }, /* AMBIENT_INT NC*/
    ...
    { 32 * 4 + 2, GSS_OUTPUT_LOW }, /* MOTOR_EN */
    { 32 * 4 + 3, GSS_INPUT_NOPULL }, /* SMB2_SCK */
    { 32 * 4 + 10, GSS_INPUT_NOPULL }, /* DRV_VBUS */
    ...
    { 32 * 5 + 1, GSS_INPUT_NOPULL }, /* UART0_CTS */
    { 32 * 5 + 2, GSS_INPUT_NOPULL }, /* UART0_RTS */
    { 32 * 5 + 3, GSS_INPUT_NOPULL }, /* UART0_TXD */

    { 32 * 5 + 6, GSS_OUTPUT_LOW }, /* DMIC_CLK */
    { 32 * 5 + 7, GSS_INPUT_NOPULL }, /* DMIC_DOUT */
