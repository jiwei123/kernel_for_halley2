...
#endif
#if IS_ENABLED(CONFIG_SND_ASOC_JZ_AIC_V12)
...
#endif
#if IS_ENABLED(CONFIG_SND_ASOC_JZ_PCM_V12)
...
static int __init board_base_init(void)
{
	...
	mipi_dsi_register_lcd_device(&orise_otm3201a_device);
#endif
	...
	mipi_dsi_register_lcd_device(&h160_tft320320_device);
#endif
