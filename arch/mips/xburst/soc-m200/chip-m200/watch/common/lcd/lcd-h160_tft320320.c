...
int h160_tft320320_init(struct lcd_device *lcd)
{
	int ret = 0;
...
int h160_tft320320_reset(struct lcd_device *lcd)
{
...
int h160_tft320320_power_on(struct lcd_device *lcd, int enable)
{
	if(!is_init && h160_tft320320_init(lcd))
		return -EFAULT;
...
struct lcd_platform_data h160_tft320320_data = {
	.reset    = h160_tft320320_reset,
	.power_on = h160_tft320320_power_on,
	.lcd_enabled = 1, // lcd panel was enabled from uboot
};

struct mipi_dsim_lcd_device h160_tft320320_device={
	.name = "h160_tft320320-lcd",
	.id   = 0,
	.platform_data = &h160_tft320320_data,
};

unsigned long h160_tft320320_cmd_buf[]= {
	0x2C2C2C2C,
};
...
struct jzfb_platform_data jzfb_pdata = {
	...
	.smart_config.write_gram_cmd = h160_tft320320_cmd_buf,
	.smart_config.length_cmd = ARRAY_SIZE(h160_tft320320_cmd_buf),
