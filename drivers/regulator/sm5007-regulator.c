...
static int SM5007_reg_is_enabled(struct regulator_dev *rdev)
{
    ...
    switch (ri->id)
    {
        ...
        case SM5007_ID_PS1 ... SM5007_ID_PS5:
            tem_enable = ((control  >> ri->en_bit) & 0x3);
            is_enable = ((tem_enable && 0x0)? 0 : (tem_enable && 0x02)? 1 : (tem_enable && 0x03)? 1 : 0);
            break;
        case SM5007_ID_LDO2:
...
static struct SM5007_regulator SM5007_regulator[] = {
	...
	SM5007_REG_BUCK(BUCK1_DVS, 0x30, 0, 0x30, 0x32, 0x3F, 0x00,
			600, 3500, 12500, 0x30, SM5007_ops, 500, sm5703_buck_output_list, 0x46, 0x01, 0x00),
    ...
    SM5007_REG_BUCK(BUCK3, 0x42, 0, 0x42, 0xFF, 0xFF, 0x00,
            3300, 3300, 0, 0x0, SM5007_ops, 500, sm5703_buck_output_list, 0x46, 0x04, 0x02),
    ...
    SM5007_REG_LDO(LDO3, 0x36, 0, 0x36, 0xFF, 0xFF, 0x00,
            1800, 1800, 0, 0, SM5007_ops, 500, sm5703_ldo_output_list, 0x43, 0x30, 0x04),
    SM5007_REG_LDO(LDO4, 0x37, 0, 0x37, 0xFF, 0xFF, 0x00,
            1800, 1800, 0, 0, SM5007_ops, 500, sm5703_ldo_output_list, 0x43, 0xC0, 0x06),
    SM5007_REG_LDO(LDO5, 0x38, 0, 0x38, 0xFF, 0xFF, 0x00,
            1800, 1800, 0, 0, SM5007_ops, 500, sm5703_ldo_output_list, 0x44, 0x03, 0x00),
    ...
    SM5007_REG_PS(PS1, 0x3D, 0, 0x3D, 0x31, 0x3F, 0x00,
            700, 1300, 12500, 0x30, SM5007_ops, 500, sm5703_buck_output_list, 0x00, 0x00, 0x00),
    ...
    SM5007_REG_PS(PS3, 0x3F, 0, 0x3F, 0xFF, 0xFF, 0x00,
            3300, 3300, 0, 0x0, SM5007_ops, 500, sm5703_buck_output_list, 0x00, 0x00, 0x00),
    SM5007_REG_PS(PS4, 0x40, 0, 0x40, 0xFF, 0xFF, 0x00,
            1800, 1800, 0, 0, SM5007_ops, 500, sm5703_ldo_output_list, 0x00, 0x00, 0x00),
