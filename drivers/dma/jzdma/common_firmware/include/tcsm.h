...
#define MAILBOX_PEND_ADDR       0xF4001000

// UART Allocate Space
#define TCSM_UART_BASE_ADDR     0xF4001100
...
#define TCSM_UART_TBUF_ADDR     (0xF4001400)
#define TCSM_UART_TBUF_LEN      0x400
#define TCSM_UART_RBUF_ADDR     (TCSM_UART_TBUF_ADDR + TCSM_UART_TBUF_LEN)
#define TCSM_UART_RBUF_LEN      0x800
